...
bool Commands::reloadInfo(Creature* creature, const std::string& cmd, const std::string& param)
{
	...
	*/
	...
	else if(param == "highscores")
	{
		...
		player->sendTextMessage(MSG_STATUS_CONSOLE_BLUE, "Reload type not found, options are: actions, commands, monsters, config, talkactions, movements, spells, raids, creaturescripts and highscores.");
