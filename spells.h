...
class ConjureSpell : public InstantSpell
{
	...
	protected:	
		...
		static bool internalConjureItem(Player* player, uint32_t conjureId, uint32_t conjureCount, bool transform = false,
			uint32_t reagentId = 0, slots_t slot = SLOT_WHEREEVER);
