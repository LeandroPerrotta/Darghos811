function onSay(cid, words, param)
	...
	local message1 = "O UltraX sera reiniciado em 5 minutos, por favor va para algum lugar seguro."
	local message2 = "O UltraX sera reiniciado em 2 minutos, por favor va para algum lugar seguro."
	local message3 = "O UltraX sera reiniciado em 60 segundos, por favor va para algum lugar seguro."
